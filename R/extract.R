...
#extension for summary.lm objects
...
extract.summary.dynlm <- extract.summary.lm
setMethod("extract",  signature = className("summary.dynlm", "dynlm"), 
          definition = extract.summary.dynlm)

extract.summary.ivreg <- extract.summary.lm
