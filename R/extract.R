...
#' created by the \code{\link[lmtest]{coeftest}} function in the \pkg{lmtest}
#' package.
#'
...
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{AER}
#' package, in particular:
#' \itemize{
#'   \item \code{ivreg} objects created by the \code{\link[AER]{ivreg}}
#'     function in the \pkg{AER} package
#'   \item \code{tobit} objects created by the \code{\link[AER]{tobit}}
#'     function in the \pkg{AER} package
#' }
#' 
#' @param include.censnobs Report the Censored number of observation parameters in the GOF block?
#' @param include.wald Report the Wald Test Value in the GOF block?
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.AER
#' @aliases extract.AER-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# alpaca package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{alpaca} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{alpaca}
#' package, in particular:
#' \itemize{
#'   \item \code{feglm} objects created by the \code{\link[alpaca]{feglm}}
#'     function in the \pkg{alpaca} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
...
#'
#' @name extract.alpaca
#' @aliases extract.alpaca-methods
#' @family extract
#' @seealso \link{extract}
...
# betareg package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{betareg} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{betareg}
#' package, in particular:
#' \itemize{
#'   \item \code{betareg} objects created by the \code{\link[betareg]{betareg}}
#'     function in the \pkg{betareg} package
#' }
#' 
...
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.betareg
#' @aliases extract.betareg-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# bife package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{bife} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{bife}
#' package, in particular:
#' \itemize{
#'   \item \code{bife} objects created by the \code{\link[bife]{bife}}
#'     function in the \pkg{bife} package
#' }
#' 
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
...
# biglm package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{biglm} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{biglm}
#' package, in particular:
#' \itemize{
#'   \item \code{biglm} objects created by the \code{\link[biglm]{biglm}}
#'     function in the \pkg{biglm} package
#' }
#' 
#' @inheritParams extract,glm-method
#' @inheritParams extract,averaging-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.biglm
#' @aliases extract.biglm-methods
#' @family extract
#' @seealso \link{extract}
...
# brms package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{brms} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{brms}
#' package, in particular:
#' \itemize{
#'   \item \code{brmsfit} objects created by the \code{\link[brms]{brm}}
#'     function in the \pkg{brms} package
#' }
#' 
...
# broom package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{broom} package
#'
#' \code{\link{extract}} methods for \code{broom} objects in the \pkg{broom}
#' package, in particular:
#' \itemize{
#'   \item These objects are created by the \code{\link[broom]{broom}} function 
#'   in the \pkg{broom} package.
#' }
#' 
#' @param model Can be any statistical model that is not covered by the
#'    \code{\link{extract}} methods in \pkg{texreg} but is covered by the
#'    \pkg{broom} package.
#' @param ... Currently not in use.
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.broom
#' @aliases extract.broom-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
#' @rdname extract.broom
#' @method extract broom
#' @aliases extract.broom
#' @export
...
# btergm package ---------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{btergm} package
#'
#' \code{\link{extract}} methods for objects created by the \pkg{btergm}
#' package, in particular:
#' \itemize{
#'   \item \code{btergm} objects, created by the \code{\link[btergm]{btergm}}
#'     function
#'   \item \code{mtergm} objects, created by the \code{\link[btergm]{mtergm}}
#'     function
#' }
#'
#' @inheritParams extract,lm-method
...
#'
#' @name extract.btergm
#' @aliases extract.btergm-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# censReg package ------------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{censReg} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{censReg}
#' package, in particular:
#' \itemize{
#'   \item \code{censReg} objects created by the \code{\link[censReg]{censReg}}
#'     function in the \pkg{censReg} package
#' }
#'
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.censReg
#' @aliases extract.censReg-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# dynlm package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{dynlm} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{dynlm}
#' package, in particular:
#' \itemize{
#'   \item \code{dynlm} objects created by the \code{\link[dynlm]{dynlm}}
#'     function in the \pkg{dynlm} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
...
# eha package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{eha} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{eha}
#' package, in particular:
#' \itemize{
#' \item \code{aftreg} objects created by the \code{\link[eha]{aftreg}}
#'     function in the \pkg{eha} package
#'   \item \code{coxreg} objects created by the \code{\link[eha]{coxreg}}
#'     function in the \pkg{eha} package
#'   \item \code{phreg} objects created by the \code{\link[eha]{phreg}}
#'     function in the \pkg{eha} package
#'   \item \code{weibreg} objects created by the \code{\link[eha]{weibreg}}
#'     function in the \pkg{eha} package
#' }
#' 
#' @param include.trisk Report the total time at risk in the GOF block?
#' @inheritParams extract,ols-method
#' @inheritParams extract,glm-method
#' @inheritParams extract,clogit-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.eha
#' @aliases extract.eha-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{ergm}
#' package, in particular:
#' \itemize{
#'   \item \code{ergm} objects created by the \code{\link[ergm]{ergm}}
#'     function in the \pkg{ergm} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
...
# forecast package -------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{forecast} package
#'
#' \code{\link{extract}} methods for models in the \pkg{forecast} package.
#'
#' \code{\link{extract}} methods for objects in the \pkg{forecast} package, in
#' particular:
#' \itemize{
#'   \item \code{ARIMA} objects, which are created by the
#'     \code{\link[forecast]{Arima}} function
#'   \item \code{ets} objects, which are created by the
#'     \code{\link[forecast]{ets}} function
#'   \item \code{forecast} objects, which are created by several functions in
#'     the \pkg{forecast} package, including the
#'     \code{\link[forecast]{forecast}} function and the
#'     \code{\link[forecast]{holt}} function
#' }
#'
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
...
#' @aliases extract.forecast-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{latentnet}
#' package, in particular:
#' \itemize{
#'   \item \code{ergmm} objects created by the \code{\link[latentnet]{ergmm}}
#'     function in the \pkg{latentnet} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.latentnet
#' @aliases extract.latentnet-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# lme4 package -----------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{lme4} package
#'
#' \code{\link{extract}} methods for \code{merMod} objects in the \pkg{lme4}
#' package, in particular:
#' \itemize{
...
# metaSEM package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{metaSEM} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{metaSEM}
#' package, in particular:
#' \itemize{
#'   \item \code{wls} objects created by the \code{\link[metaSEM]{wls}}
#'     function in the \pkg{metaSEM} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.metaSEM
#' @aliases extract.metaSEM-methods
#' @family extract
#' @seealso \link{extract}
#' @author Christoph Riedl, Philip Leifeld
NULL
...
# mfx package ------------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{mfx} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{mfx}
#' package, in particular:
#' \itemize{
...
#'     function in the \pkg{mfx} package
#'   \item \code{logitmfx} objects created by the \code{\link[mfx]{logitmfx}}
#'     function in the \pkg{mfx} package
#'   \item \code{logitor} objects created by the \code{\link[mfx]{logitor}}
#'     function in the \pkg{mfx} package
#'   \item \code{negbinirr} objects created by the \code{\link[mfx]{negbinirr}}
#'     function in the \pkg{mfx} package
#'   \item \code{negbinmfx} objects created by the \code{\link[mfx]{negbinmfx}}
#'     function in the \pkg{mfx} package
#'   \item \code{poissonirr} objects created by the \code{\link[mfx]{poissonirr}}
#'     function in the \pkg{mfx} package
#'   \item \code{poissonmfx} objects created by the \code{\link[mfx]{poissonmfx}}
#'     function in the \pkg{mfx} package
#'   \item \code{probitmfx} objects created by the \code{\link[mfx]{probitmfx}}
#'     function in the \pkg{mfx} package
#' }
#'
...
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{mgcv}
#' package, in particular:
#' \itemize{
#'   \item \code{bam} objects created by the \code{\link[mgcv]{bam}}
#'     function in the \pkg{mgcv} package
#'   \item \code{gam} objects created by the \code{\link[mgcv]{gam}}
#'     function in the \pkg{mgcv} package
#' }
#'
#' @param include.smooth Report the smooth terms in the coefficient block?
#' @param include.dev.expl Report the deviance explained in the GOF block?
#' @param include.dispersion Report the dispersion in the GOF block?
#' @param include.gcv Report the minimised generalised cross-validation (GCV) in the GOF block?
#' @param include.nsmooth Report number of the smooth terms in the GOF block?
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.mgcv
#' @aliases extract.mgcv-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# ordinal package --------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{ordinal} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{ordinal}
#' package, in particular:
#' \itemize{
#'   \item \code{clm} objects created by the \code{\link[ordinal]{clm}}
#'     function
#'   \item \code{sclm} objects
...
#' @aliases extract.ordinal-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# plm package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{plm} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{plm}
#' package, in particular:
#' \itemize{
#'   \item \code{pgmm} objects created by the \code{\link[plm]{pgmm}}
#'     function in the \pkg{pgmm} package
#'   \item \code{plm} objects created by the \code{\link[plm]{plm}}
#'     function in the \pkg{plm} package
#'   \item \code{pmg} objects created by the \code{\link[plm]{pmg}}
#'     function in the \pkg{plm} package
#' }
#' 
#' @param include.sargan Report the Hansen–Sargan test in the GOF block?
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @inheritParams extract,tobit-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.plm
#' @aliases extract.plm-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# pglm package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{pglm} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{pglm}
#' package, in particular:
#' \itemize{
#'   \item \code{maxLik} objects created by the \code{\link[pglm]{pglm}}
#'     function in the \pkg{pglm} package
#' }
#' 
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
...
#' @noRd
extract.maxLik <- function(model, include.aic = TRUE,
                           include.loglik = TRUE, include.nobs = TRUE, ...) {
    s <- summary(model, ...)
...
setMethod("extract", signature = className("maxLik", "pglm"),
          definition = extract.maxLik)


# pscl package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{pscl} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{pscl}
#' package, in particular:
#' \itemize{
#'   \item \code{zeroinfl} objects created by the \code{\link[pscl]{zeroinfl}}
#'     function in the \pkg{pscl} package
#'   \item \code{hurdle} objects created by the \code{\link[pscl]{hurdle}}
#'     function in the \pkg{pscl} package
#' }
#' 
#' @param beside If beside = TRUE report Count Model and Zero Model in 
#'    two different columns
#' @param include.count Report count model in the coefficient block?
#' @param include.zero Report zero model in the coefficient block?
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.pscl
#' @aliases extract.pscl-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# quantreg package ------------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{quantreg} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{quantreg}
#' package, in particular:
#' \itemize{
#'   \item \code{rq} objects created by the \code{\link[quantreg]{rq}}
#'     function in the \pkg{quantreg} package
#' }
#' 
#' @param include.percentile Report Percentile in the GOF block?
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.quantreg
#' @aliases extract.quantreg-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# relevent package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{relevent} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{relevent}
#' package, in particular:
#' \itemize{
#'   \item \code{rem.dyad} objects created by the \code{\link[relevent]{rem.dyad}}
#'     function in the \pkg{relevent} package
#' }
#' 
#' @param include.nvertices Report the number of nodes in the GOF block?
#' @inheritParams extract,glm-method
#' @inheritParams extract,ets-method
#' @inheritParams extract,clogit-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.relevent
#' @aliases extract.relevent-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
#' package, in particular:
#' \itemize{
#'   \item \code{lmRob} objects created by the \code{\link[robust]{lmRob}}
#'     function in the \pkg{robust} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
...
# rms package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{rms} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{rms}
#' package, in particular:
#' \itemize{
#'   \item \code{lrm} objects created by the \code{\link[rms]{lrm}}
#'     function in the \pkg{rms} package
#'   \item \code{ols} objects created by the \code{\link[rms]{ols}}
#'     function in the \pkg{rms} package
#' }
#' 
#' @param include.lr Report the model likelihood ration (L.R.) in the GOF block?
#' @inheritParams extract,lm-method
#' @inheritParams extract,betamfx-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.rms
#' @aliases extract.rms-methods
#' @family extract
#' @seealso \link{extract}
#' @author Fabrice Le Lec, Philip Leifeld
NULL
...
# RSiena package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{RSiena} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{RSiena}
#' package, in particular:
#' \itemize{
#'   \item \code{sienaFit} objects created by the \code{\link[RSiena]{siena07}}
#'     function in the \pkg{RSiena} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @inheritParams extract,mnlogit-method
...
#'
#' @name extract.RSiena
#' @aliases extract.RSiena-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
#' 
#' \code{\link{extract}} methods for models in the \pkg{sampleSelection} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{sampleSelection}
#' package, in particular:
#' \itemize{
#'   \item \code{selection} objects created by the \code{\link[sampleSelection]{selection}}
#'     function in the \pkg{sampleSelection} package
#' }
#' 
#' @param prefix When TRUE reports the indices of the observed and cersored variables
#'  in the coefficient block. 
#' @param include.selection ?
#' @param include.outcome ?
#' @param include.errors ?
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.sampleSelection
#' @aliases extract.sampleSelection-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# problem ########################
# several parameters not printing even if set to true
...
#' @rdname extract.sampleSelection
...
# simex package ------------------------------------------------------------------
#'
#' \code{\link{extract}} methods for models in the \pkg{simex} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{simex}
#' package, in particular:
#' \itemize{
#'   \item \code{simex} objects created by the \code{\link[simex]{simex}}
#'     function in the \pkg{simex} package
#' }
#' 
#' @param jackknife Report jackknife variance estimation in the GOF block?
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.simex
#' @aliases extract.simex-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
# problem ########################
# param  jackknife not printing even if set to TRUE
...
# sna package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{sna} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{sna}
#' package, in particular:
#' \itemize{
#'   \item \code{lnam} objects created by the \code{\link[sna]{lnam}}
#'     function in the \pkg{sna} package
#'   \item \code{netlogit} objects created by the \code{\link[sna]{netlogit}}
#'     function in the \pkg{sna} package
#' }
#' 
#' @inheritParams extract,lm-method
...
# spatialreg package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{spatialreg} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{spatialreg}
#' package, in particular:
#' \itemize{
#'   \item \code{sarlm} objects created by the \code{\link[spatialreg]{lagsarlm}}
#'     function in the \pkg{spatialreg} package
#' }
#' 
#' @inheritParams extract,glm-method
#' @inheritParams extract,ols-method
...
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.spatialreg
#' @aliases extract.spatialreg-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# survey package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{survey} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{survey}
#' package, in particular:
#' \itemize{
#'   \item \code{svyglm} objects created by the \code{\link[survey]{svyglm}}
#'     function in the \pkg{survey} package
#' }
#' 
#' @inheritParams extract,gam-method
#' @inheritParams extract,glm-method
...
#'
#' @name extract.survey
#' @aliases extract.survey-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# survival package -------------------------------------------------------------
#'
#' \code{\link{extract}} method for models in the \pkg{survival} package
#'
#' \code{\link{extract}} methods for statistical models defined in the
#' \pkg{survival} package, in particular:
#' \itemize{
#'   \item \code{clogit} objects, which are created by the
#'     \code{\link[survival]{clogit}} function
#'   \item \code{coxph} objects, which are created by the
#'     \code{\link[survival]{coxph}} function
#'   \item \code{coxph.penal} objects, which are created by the
#'     \code{\link[survival]{coxph}} function
#'   \item \code{survreg} objects, which are created by the
#'     \code{\link[survival]{survreg}} function
#'   \item \code{survreg.penal} objects, which are created by the
#'     \code{\link[survival]{survreg}} function
#' }
#'
...
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.survival
#' @aliases extract.survival-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
#'
...
# systemfit package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{systemfit} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{systemfit}
#' package, in particular:
#' \itemize{
#'   \item \code{systemfit} objects created by the \code{\link[systemfit]{systemfit}}
#'     function in the \pkg{systemfit} package
#' }
#' 
#' @param include.suffix If include.suffix = TRUE show system elements in parethesis 
#' after each coefficient
#' @param beside if beside = TRUE show system elements in separate columns
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.systemfit
#' @aliases extract.systemfit-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# tergm package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{tergm} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{tergm}
#' package, in particular:
#' \itemize{
#'   \item \code{stergm} objects created by the \code{\link[tergm]{stergm}}
#'     function in the \pkg{tergm} package
#' }
#' @param beside If beside = TRUE report Formation and Dissolution in two different columns
#' @param include.formation Report Formation in the coefficient block?
#' @param include.dissolution Report Dissolution in the coefficient block?
#' @inheritParams extract,rem.dyad-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.tergm
#' @aliases extract.tergm-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# texreg package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{texreg} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{texreg}
#' package, in particular:
#' \itemize{
#'   \item \code{texreg} objects created by the \code{\link[texreg]{texreg}}
#'     function in the \pkg{texreg} package
#' }
#' 
#' @inheritParams extract,lm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.texreg
#' @aliases extract.texreg-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
# VGAM package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{VGAM} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{VGAM}
#' package, in particular:
#' \itemize{
#'   \item \code{vglm} objects created by the \code{\link[VGAM]{vglm}}
#'     function in the \pkg{VGAM} package
#' }
#' 
#' @inheritParams extract,glm-method
#' @inheritParams extract,gnm-method
...
# Zelig package ------------------------------------------------------------------
#' 
#' \code{\link{extract}} methods for models in the \pkg{Zelig} package
#'
#' \code{\link{extract}} methods for statistical models in the \pkg{Zelig}
#' package, in particular:
#' \itemize{
#'   \item \code{Zelig} objects created by the \code{\link[Zelig]{zelig}}
#'     function in the \pkg{Zelig} package
#'   \item \code{Zelig} objects created by the \code{\link[Zelig]{Zelig}}
#'     function in the \pkg{Zelig} package
#' }
#' 
#' @param include.nimp Report Akaike's Information Criterion (AIC) in the GOF block?
#' @inheritParams extract,lm-method
#' @inheritParams extract,glm-method
#' @return A \linkS4class{texreg} object.
#'
#' @name extract.Zelig
#' @aliases extract.Zelig-methods
#' @family extract
#' @seealso \link{extract}
#' @author Philip Leifeld
NULL
...
## problem #########################################################
# I think this one of these two function is not anymore on the Zelig 
# package. At the moment the function zelig produces class Zelig. 
# However, the majority of the arguments in these extract functions 
# are not present in the output. If you want I can write a new function
# but please have a look, I might have miss some information. Maybe this
# is ok
...
## Problem #############################################
# NOT ON CRAN ANYMORE  impossible to write test of verify name of function
