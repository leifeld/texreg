...
\caption[List of 54 supported model types (version 1.31).]{\label{tab:types} List of 54 supported model types (version 1.31).} \\
\endlastfoot
...
\pkg{texreg} (version 1.31), in contrast, can deal with all of the
