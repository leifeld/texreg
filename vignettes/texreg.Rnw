...
<<<<<<< HEAD
\caption[List of 100 supported model types (version 1.36.24).]{\label{tab:types} List of 100 supported model types (version 1.36.24).} \\
\endlastfoot
`\code{aftreg}'         & \pkg{eha}             & Accelerated failure time regression \\
=======
\caption[List of 99 supported model types (version 1.36.24).]{\label{tab:types} List of 99 supported model types (version 1.36.24).} \\
\endlastfoot

`\code{aftreg}'         & \pkg{eha}	            & Accelerated failure time regression \\
>>>>>>> 7fc3504e7b747624be3674a170d34720830bc5ad
