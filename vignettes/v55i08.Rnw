...
\caption[List of 56 supported model types (version 1.33).]{\label{tab:types} List of 56 supported model types (version 1.33).} \\
\endlastfoot
...
\pkg{texreg} (version 1.33), in contrast, can deal with all of the
