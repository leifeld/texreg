...
\caption[List of 65 supported model types (version 1.36).]{\label{tab:types} List of 65 supported model types (version 1.36).} \\
\endlastfoot
...
`\code{gmm}', `\code{lme}', `\code{lme4}', `\code{lnam}', `\code{maBina}', 
`\code{mlogit}', `\code{mnlogit}', `\code{model.selection}', 
