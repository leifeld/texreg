...
\caption[List of 63 supported model types (version 1.35).]{\label{tab:types} List of 63 supported model types (version 1.35).} \\
\endlastfoot
...
`\code{lme4}', `\code{lnam}', `\code{maBina}', `\code{mlogit}', 
`\code{mnlogit}', `\code{model.selection}', `\code{netlogit}', 
`\code{nlme}', `\code{rem.dyad}', `\code{rq}', `\code{sclm}', 
`\code{selection}', `\code{stergm}', `\code{systemfit}', and 
