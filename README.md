...
Please feel free to report bugs or possible enhancements using the issue tracker and propose solutions for known bugs using a pull request. Important: I will only consider pull requests that address an issue described in the issue tracker.
