...
An example:
<<results=tex>>=
table <- texreg(list(m1, m2), use.packages=FALSE, label="tab:3", caption="My regression table", scriptsize=TRUE, custom.names=c("(Intercept)", "Treatment", "Control"), model.names=c("First model", "Second model"))
@
