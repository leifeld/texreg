...
\title{texreg: Conversion of Statistical Model Output in R to \LaTeX\ and HTML Tables\thanks{The author would like to thank S.\,Q. Chang, Skyler Cranmer, Sebastian Daza, Christopher Gandrud, Gupta Gupta, Lena Koerber, Johannes Kutsam, Fabrice Le Lec, Florian Oswald, Francesco Sarracino, Matthieu Stigler, Sebastian Ugbaje, G{\'a}bor Uhrin, Yanghao Wang, and Yihui Xie for valuable input.}}
\author{Philip Leifeld $<$\href{mailto:philip.leifeld@uni-konstanz.de}{philip.leifeld@uni-konstanz.de}$>$}
...
\texttt{maBina}		& \texttt{erer}			& 2013-05-21	& Marginal effects for logit and probit models \\
