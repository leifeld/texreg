...
\texttt{lmerMod}	& \texttt{lme4}			& Philip Leifeld	& 2012-10-08	& Linear mixed effects models \\
\texttt{lnam}		& \texttt{sna}			& Philip Leifeld	& 2012-10-07	& Linear network autocorrelation models \\
\texttt{mer}		& \texttt{lme4}			& Philip Leifeld	& 2012-10-08	& Linear mixed effects models \\
