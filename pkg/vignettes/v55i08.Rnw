...
\caption[List of 58 supported model types (version 1.33).]{\label{tab:types} List of 58 supported model types (version 1.33).} \\
\endlastfoot
...
`\code{fGARCH}', `\code{gamlss}', `\code{glmrob}', `\code{gmm}', 
