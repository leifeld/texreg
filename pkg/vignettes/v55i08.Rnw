...
\caption[List of 62 supported model types (version 1.35).]{\label{tab:types} List of 62 supported model types (version 1.35).} \\
\endlastfoot
...
`\code{coxph.penal}', `\code{ergmm}', `\code{fGARCH}', `\code{gamlss}', 
`\code{glmmadmb}', `\code{glmrob}', `\code{gmm}', `\code{lme}', 
`\code{lme4}', `\code{lnam}', `\code{maBina}', `\code{model.selection}', 
